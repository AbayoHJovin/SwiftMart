...
export default function OrderTable({
  ...
  const handleApprovalBadgeClick = (e, message) => {
    e.stopPropagation();
    if (message) {
  ...
  return (
    <>
                ...
                filteredOrders?.map((item, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {item.approved ? (
                        <button
                          onClick={(e) => handleApprovalBadgeClick(e, item.approvalMessage)}
                        ...
                        >
                          {item.approvalMessage ? 'Approved with Message' : 'Approved'}
                        </button>
                      ) : (
      ...
      >
        <div className="p-4">
          <p className="text-gray-700 dark:text-gray-300">{selectedMessage}</p>
        </div>
      </Modal>
    </>
  );
